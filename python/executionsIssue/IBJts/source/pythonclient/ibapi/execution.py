...
class Execution(Object):
    ...
    def __str__(self):
        return "ExecId: %s, Time: %s, Account: %s, Exchange: %s, Side: %s, Shares: %s, Price: %s, PermId: %s, " \
                ...
                "EvMultiplier: %s, ModelCode: %s, LastLiquidity: %s, PendingPriceRevision: %s" % (self.execId, self.time, self.acctNumber, 
                ...
                self.modelCode, intMaxString(self.lastLiquidity), self.pendingPriceRevision)
